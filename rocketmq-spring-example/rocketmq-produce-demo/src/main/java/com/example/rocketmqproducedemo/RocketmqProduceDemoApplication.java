...
import com.example.rocketmqproducedemo.domain.OrderPaidEvent;
...
public class RocketmqProduceDemoApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(RocketmqProduceDemoApplication.class, args);
    }
