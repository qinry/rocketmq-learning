package com.example.rocketmqproduceaclexample;
...
public class RocketmqProduceAclExampleApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(RocketmqProduceAclExampleApplication.class, args);
    }
